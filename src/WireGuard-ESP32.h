...
public:
    bool begin(const IPAddress& localIP, const IPAddress& allowedIp, const IPAddress& allowedMask, const IPAddress& Netmask, const IPAddress& Gateway, const char* privateKey, const char* remotePeerAddress, const char* remotePeerPublicKey, uint16_t remotePeerPort);
